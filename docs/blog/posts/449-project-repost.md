...
<div class="stat-card" markdown="1"><span class="stat-num">75+</span><span class="stat-label">students across the cohort</span></div>
<div class="stat-card" markdown="1"><span class="stat-num">17</span><span class="stat-label">full-stack AI apps shipped</span></div>
<div class="stat-card" markdown="1"><span class="stat-num">1</span><span class="stat-label">Winter semester, idea to demo</span></div>
<div class="stat-card" markdown="1"><span class="stat-num">7+</span><span class="stat-label">domains, from health to finance</span></div>
</div>
...
Same backend, frontend, and AI — one language. The setup behind 17 student apps is a few minutes away.
